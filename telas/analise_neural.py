...
def analiseNeural(df, nome_tabela, selected_graficos):
    ...
    prof_train, forecast_train, df_train, future_train, fig = create_neural_object(train_data, tamanhoPrevisao)
    ...
    with col3:
        ...
        prof_testS, forecast_testS, df_testS, future_testS, fig = create_neural_object(test_dataS, 1)
    ...
    if option:
        ...
        ####função
        calcular_erros(test_data, forecast_train['yhat1'], st, option2)